...
# 		MeshPhongMaterial(color = Colors.RGBA(0.0, 0.0, 0.0, 1.0)))
#
...
#                 MeshPhongMaterial(color = Colors.RGBA(1.0, 165.0 / 255.0, 0.0, 1.0)))
#         end
#     end
#
#     if force_vis
# 	       force_vis = ArrowVisualizer(vis[:force])
#     	setobject!(force_vis, MeshPhongMaterial(color=Colors.RGBA(1.0, 0.0, 0.0, 1.0)))
#
