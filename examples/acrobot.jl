...
visualize_elbow!(vis, model,
    ...
    # limit_color = Colors.RGBA(0.0, 1.0, 0.0, 1.0),
    limit_color = Colors.RGBA(1.0, 0.0, 0.0, 1.0),
    Δt = h)
#
# # ghost
...
#         tl = tl,
#         limit_color = Colors.RGBA(limit_color..., tl),
#         i = id)
...
# _set_acrobot!(vis, model, x[t], i = id)
#
# # line_mat = LineBasicMaterial(color=color=Colors.RGBA(1.0, 153.0 / 255.0, 51.0 / 255.0, 1.0), linewidth=10.0)
# line_mat = LineBasicMaterial(color=color=Colors.RGBA(51.0 / 255.0, 1.0, 1.0, 1.0), linewidth=10.0)
#
