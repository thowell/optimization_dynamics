...
# f1(zeros(4 * hopper.nq), im_dyn1, rand(im_dyn1.n), rand(im_dyn1.m), zeros(0))
...
# f1x(zeros(4 * hopper.nq, 2 * hopper.nq), im_dyn1, rand(im_dyn1.n), rand(im_dyn1.m), zeros(0))
...
# f1u(zeros(4 * hopper.nq, hopper.nu + 2 * hopper.nq), im_dyn1, rand(im_dyn1.n), rand(im_dyn1.m), zeros(0))
...
# ft(zeros(4 * hopper.nq), im_dynt, rand(im_dynt.n), rand(im_dynt.m), zeros(0))
...
# ftx(zeros(4 * hopper.nq, 4 * hopper.nq), im_dynt, rand(im_dynt.n), rand(im_dynt.m), zeros(0))
...
# ftu(zeros(4 * hopper.nq, hopper.nu), im_dynt, rand(im_dynt.n), rand(im_dynt.m), zeros(0))
...
# ## rollout
ū_stand = [t == 1 ? [0.0; hopper.gravity * hopper.mass_body * h; x1] : [0.0; hopper.gravity * hopper.mass_body * 0.5 * h] for t = 1:T-1]
