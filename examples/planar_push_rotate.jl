...
q1 = [0.0, 0.0, 0.0, -r_dim - 1.0e-8, -0.01]
x1 = [q0; q1]
ū = [t < 5 ? [1.0; 0.0] : t < 10 ? [0.5; 0.0] : [0.0; 0.0] for t = 1:T-1]
...
_create_planar_push!(vis, model,
        ...
        box_color = Colors.RGBA(0.0, 1.0, 0.0, 0.5),
        pusher_color = Colors.RGBA(0.5, 0.5, 0.5, 0.0))
...
# _set_planar_push!(vis, model, q̄[t], i = id)
#
# box_line_mat = LineBasicMaterial(color=color=Colors.RGBA(1.0, 153.0 / 255.0, 51.0 / 255.0, 1.0), linewidth=10.0)
# pusher_line_mat = LineBasicMaterial(color=color=Colors.RGBA(51.0 / 255.0, 1.0, 1.0, 1.0), linewidth=10.0)
#
